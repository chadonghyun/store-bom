...
//상품목록에서 선택한 no를 변수에 담는다.
$no1 = $_GET['no']; //1,2,3,4,5,6...
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
          ...
          //mysqli_fetch_array
          //mysqli_query를 통해 얻은 리절트 셋(result set)에서 레코드를 1개씩 리턴해주는 함수        
          ...
          // echo $result2;
          //일반 + 연관배열 출력하기
          // print_r($row); //전체데이터 출력        
          // print_r($row2); //이미지와 번호만 출력        

        ?>

        <!-- 사용자가 선택한 제품 상세페이지 출력 -->
        <div class="col-sm-9 padding-right">
          <div class="product_details"> <!-- 상품 상세페이지 -->
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    ...
                    <a href="product-details.php?no<?=$row2['no']?>">
                      <img src="<?=$row2['img']?>" alt="" style="width : 70px; height:70px;">
                    </a>
                    <?php } ?>
                  </div>
                </div>
                <a href="#similar-product" class="left item-control" data-slide="prev">
                  <i class="fa fa-angle-left"></i>
                </a>
                <a href="#similar-product" class="right item-control" data-slide="next">
                  <i class="fa fa-angle-right"></i>
                </a>
              </div>
            <div class="col-sm-7">
              <div class="product-information">
                <img src="./images/product-details/new.jpg" alt="" class="newarrial">  
                <form action="" method="post">
                  <h2><?=$name?></h2>     
                  <p>상품번호 : <?=$no2?></p>
                  <img src="./images/product-details/rating.png" alt="">
                  <p><?=number_format($price)?>원</p>
                  <p><label for="">수량</label>
                    <input type="text" name="quantity" value="1">    
                  </p>
                  <p>
                    <button type="submit" class="btn btn-fafault cart">
                      <i class="fa fa-shopping-acrt"></i>  
                      장바구니 추가
                    </button>
                  </p>      
                  <p>
          ...
          <div><?=$memo?><img src="<?=$d_img?>" alt=""></div>    
        </div>             
      </div>
    </div>
  </section>
