        ...
        <div class="col-sm-4 col-sm-offset-1 padding-right">
          <div class="login-form">
            <form name="회원가입" id="member_form" method="post" action="member_insert.php">
              ...
              <button type="submit" class="btn btn-default" style="display: inline;" id="save_frm">확인</button>
              <button type="reset" class="btn btn-danger" style="display: inline;">다시쓰기</button>
            </form>
          </div>
        </div>
      </div>
